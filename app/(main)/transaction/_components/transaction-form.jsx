...
<div className="space-y-2">
        ...
        <Select
onValueChange={(value)=>setValue("type",value)} defaultValue={type}
>
<SelectTrigger>
...
<div className="grid gap-6 md:grid-cols-2">
    <div className="space-y-2">
       ...
       <Input type="number" step="0.01" placeholder="0.00" {...register("amount")}/>
        ...
        <label className="text-sm font-medium">Amount</label>
        <Select
onValueChange={(value)=>setValue("accountId",value)} defaultValue={getValues("accountId")}
>
<SelectTrigger>
...
{errors.accountId && (
    ...
    <div className="space-y-2">
        ...
        <Select
onValueChange={(value)=>setValue("category",value)} defaultValue={getValues("category")}
>
<SelectTrigger>
...
<div className="space-y-2">
  ...
  {date?format(date,"PPP"):<span>Pick up a date</span>}
       ...
       <Input  placeholder="Enter description" {...register("description")}/>
        ...
        <div>
                   ...
                   <div className="flex items-center justify-between rounded-lg border p-3">
                    ...
                    <Switch  checked={isRecurring} id='isDefault'  onCheckedChange={(checked)=>setValue("isRecurring",checked)} />
                    
                   </div>
                   {isRecurring && <div className="space-y-2">
        <label className="text-sm font-medium">Recurring Interval</label>
        <Select
onValueChange={(value)=>setValue("recurringInterval",value)} defaultValue={getValues("recurringInterval")}
>
<SelectTrigger>
